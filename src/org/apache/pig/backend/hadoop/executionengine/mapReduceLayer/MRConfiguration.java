...
public class MRConfiguration {
    ...
    public static final String JOB_REDUCE_MARKRESET_BUFFER_PERCENT = "mapreduce.reduce.markreset.buffer.percent";
    public static final String JOB_TRACKER = "mapred.job.tracker";
    public static final String JOB_TRACKER_HTTP_ADDRESS = "mapreduce.jobtracker.http.address";
    ...
    public static final String OUTPUT_COMPRESS = "mapreduce.output.fileoutputformat.compress";
    ...
    public static final String REDUCE_TASKS = "mapreduce.job.reduces";
    ...
    public static final String TASK_ID = "mapreduce.task.attempt.id";
